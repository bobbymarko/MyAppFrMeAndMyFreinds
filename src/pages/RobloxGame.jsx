...
const RobloxGame = () => {
  ...
  const getGameEmbedUrl = (placeId, isLocal = false) => {
    ...
    // For online games, show a play button instead of trying to embed
    return null;
  };
      ...
      <div className="game-area" style={{ 
        ...
        {isLoading ? (
          ...
          <iframe
            ...
            onError={() => {
              setIsLoading(false);
              console.error('Failed to load local game');
            }}
          ...
          <div style={{
            ...
            <div style={{ marginBottom: '30px' }}>
              ...
              <p style={{ color: '#ccc', fontSize: '18px', marginBottom: '30px' }}>
                Click the buttons above to launch your selected game directly in Roblox!
              </p>
              <div style={{ 
                ...
                <h3 style={{ color: '#00a2ff', marginBottom: '10px' }}>
                  {gameOptions.find(g => g.id === selectedGame)?.name || 'Selected Game'}
                </h3>
